...
*/
    ...
    // const ordenarPorFechas =(noticias)=> {

    //esto es las fechas de mas antiguo a nuevo
    const fechasAscendente = (noticias) => {
        noticias.sort((a, b) => {
            let dateA = new Date((a.date) * 1000); //convertir el timestamp a milisegundos
            let dateB = new Date((b.date) * 1000);
    ...
    const fechasDescendente =(noticias) =>{
        noticias.sort((a, b) => {
    ...
    window.steam = {  //objeto que contiene todos los métodos
        ...
        fechasAscendente:fechasAscendente,
        fechasDescendente:fechasDescendente,
